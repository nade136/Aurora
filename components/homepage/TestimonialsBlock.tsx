        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="space-y-4">
            ...
            {t.seeMore?.label && t.seeMore?.url && (
              <a
                href={t.seeMore.url}
                className="text-sm text-lime-300 hover:underline inline-flex items-center gap-1"
              >
                {t.seeMore.label}
            ...
            <div className="space-y-2">
              {items.slice(0, 2).map((it, i) => (
                <div
                  key={i}
                  className="flex items-center gap-3 bg-gray-800/60 border border-white/10 rounded-full px-3 py-2"
                >
                  {it?.avatar ? (
          ...
          <div className="bg-gray-800/60 border border-white/10 rounded-xl p-5 flex flex-col justify-between">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              {featured?.text || "A compelling quote to highlight in the center of the section."}
            </p>
            {featured && (
          ...
          <div className="bg-gray-800/60 border border-white/10 rounded-xl p-4">
            {featured && (
              <div className="mb-3 flex items-center gap-2">
                ...
                <div className="text-xs">
                  <div className="font-medium truncate max-w-[10rem] text-white">
                    {featured.name || "Name"}
                  </div>
